            ...
            <div className="px-10 py-5 ">
                ...
                <div className="flex gap-5 items-center">
                    <div className=" rounded-2xl relative">
                        ...
                        <div className="bg-[#001220] bg-opacity-70 flex justify-between absolute bottom-0 p-8 w-full rounded-b-2xl">
                            <p className="text-2xl text-slate-100 font-semibold">Dhaka Max</p>
                            {
                                user ?
                                    <>
                    ...
                    <div className=" rounded-2xl relative">
                        ...
                        <div className="bg-[#001220] bg-opacity-70 flex justify-between absolute bottom-0 p-8 w-full rounded-b-2xl">
                            <p className="text-2xl text-slate-100 font-semibold">Sylhet 25K</p>
                            {
                                user ?
                                    <>
